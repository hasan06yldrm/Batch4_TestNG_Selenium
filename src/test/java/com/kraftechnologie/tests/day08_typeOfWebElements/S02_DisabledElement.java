...
public class S02_DisabledElement {

    /** What is disabled element ?
     * U can NOT interact with this element (etkileşime girilemez)
     * U can NOT click
    ...
    public void disabledElementTest1() throws InterruptedException {
        ...
        Assert.assertFalse(disabledElement.isEnabled(),"Verify that element " +
                "is NOT enable or element is disable");

        //if we click the enable button it will be interactive
        WebElement enableBtn=disabledElement.findElement(By.cssSelector("#input-example>button"));
        enableBtn.click();
        Thread.sleep(4000);
