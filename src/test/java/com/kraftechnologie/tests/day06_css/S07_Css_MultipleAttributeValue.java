...
public class S07_Css_MultipleAttributeValue {
    public static void main(String[] args) throws InterruptedException {
        //THERE İS OR LOGIC WITH CSS
        ...
        //System.out.println("readOnlyDisabled.getText() = " + readOnlyDisabled.getText());//boş string döndürdü başarılı aslında
